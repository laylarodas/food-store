...
export default function OrderCard({ order }: OrderCardProps) {
    ...
    return (
        ...
        >
            <p className='text-2xl font-medium text-gray-900'>Customer: {order.name} </p>
            ...
            <dl className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                    <dt className="text-base font-medium text-gray-900">Total to pay: {formatCurrency(order.total)}</dt>
